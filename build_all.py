#!/usr/bin/env python3
"""
OpenAL Shared Example Plugin Cross-Platform Build Script
...
def main():
    parser = argparse.ArgumentParser(
        description='OpenAL Shared Example Plugin Cross-Platform Build Script',
...
Examples:
    ...
    print(f"=== OpenAL Shared Example Plugin Build Script ===")
    ...
    if success:
        ...
        if output_file.exists():
            ...
            print(f"  X-Plane/Resources/plugins/OpenALSharedExample/{expected_output}")
            print(f"  Also copy sound.wav file to the same directory")
