#!/usr/bin/env python3
"""
OpenAL Shared Example Plugin Cross-Platform Test Script
...
def main():
    print("[TEST] OpenAL Shared Example Plugin Cross-Platform Compilation Configuration Test")
    print("=" * 70)
